    ...
    <body class="bg-gray-100 p-4">
        <div class="max-w-md mx-auto bg-white p-4 rounded shadow">
            ...
            <div class="relative mb-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <button type="button" onclick="startScan()" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded">Scan</button>
                </div>
            ...
            <div id="scanner-container" class="hidden mb-4">
                ...
                <button type="button" onclick="stopScan()" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded mt-2">Batalkan</button>
            </div>
        ...
        async function startScan() {
            if (!('BarcodeDetector' in window)) {
                alert('Pemindaian barcode tidak didukung pada perangkat ini.');
                return;
            }
